...
export function ChapterList(): ReactElement | null {
  ...
  return (
    ...
    >
      <div style={{ padding: "0 16px 8px", fontWeight: 600, fontSize: 13, color: "var(--text-secondary)" }}>Chapters</div>
          ...
          return (
            <li key={ch.id}>
              ...
              >
                ...
                <div style={{ fontSize: 11, color: "var(--text-muted)", marginTop: 2 }}>{formatHhMmSs(ch.start_time)}</div>
              </button>
            </li>
          );
        })}
